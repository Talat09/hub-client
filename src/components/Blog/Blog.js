...
import img1 from "../../assets/blog-img3.jpg";
const Blog = () => {
  return (
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <p className="text-sm">
          <span className="text-[#5A6069]">Author:</span>{" "}
        ...
        <p className="text-sm text-[#5A6069] tracking-wider leading-6 mt-4">
          ...
          similique alias earum doloribus totam, dolore magni sint voluptatem,
          quasi aliquid. Explicabo sed aliquam adipisci, autem odit ratione
          dolorem labore...
        </p>
        <button className="btn bg-primary text-white rounded-full mt-4 px-10 hover:bg-secondary hover:text-black">
