...
const UpdateProfile = () => {
  ...
  const { email, name, education, city, division, phone, linkedIn } =
    userDetails;
  ...
  return (
    <form
      ...
      className="shadow rounded-xl px-6 pb-10 lg:p-0 lg:px-20 lg:pb-10"
    >
      ...
      <div className="grid lg:grid-cols-2 gap-x-10 text-black">
        ...
        <div className="form-control mt-2">
          ...
          <input
            ...
            value={division}
            onChange={(e) =>
              setUserDetails({ ...userDetails, division: e.target.value })
            }
            type="text"
