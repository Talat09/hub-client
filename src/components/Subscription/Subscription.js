...
const Subscription = () => {
  return (
    <div className="max-w-7xl mx-auto mb-20 px-6 lg:px-10 border-t-[1px] border-[#363C45]">
      <p className="text-sm text-red-500 uppercase text-center mt-20">
      ...
      <form className="flex justify-center items-center md:w-1/2 mx-auto my-14 md:my-20 relative">
        <input
          ...
          className="bg-white text-white outline-red-500 border border-gray-500 p-4 pl-8 rounded-full w-full text-sm"
        />
        <button className="bg-red-500 text-white  rounded-full absolute right-1">
